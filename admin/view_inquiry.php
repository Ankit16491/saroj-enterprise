...
$id = (isset($_GET['id']) ? (int) $_GET['id'] : 0);
        ...
        include './dao.php';
        $v = new dao();
       $s = $v->select("inquirydata","inq_id=$id");
        ...
        <html>
            <body>
                ...
                <table border="1" align="center" width="800px">
                    <tr>
                        <td colspan="4" style="text-align:center;"><p style="word-wrap:break-word; width:100px;"><strong><h1>Inquiry Data</h1></strong></p></td>
                    </tr>
                    ...
                    <tr>
                        <td>Nos : </td>
                        <td><b><?php echo $nos; ?></b></td>
                    </tr>
                    <tr>
                        <td>Delivery : </td>
                        <td><b><?php echo $delivery; ?></b></td>
                    </tr>
