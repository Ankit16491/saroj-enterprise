          ...
          if($_SERVER['REQUEST_METHOD'] == "POST")
          {
                 ...
                 { 
                     ...
                     //$res=mysql_query("Select * from stock_master");
                      $res=mysql_query("SELECT stock_master.stock_id,stock_master.section,stock_master.make,stock_master.quantity,stock_master.deliver_from_godown, grade_master.grade_name,stock_master.grade_id FROM stock_master INNER JOIN grade_master ON stock_master.grade_id=grade_master.grade_id");
                      
                 }
                 else
                 { 
                     //$res=mysql_query("Select * from stock_master where grade_id='".$des."'");
                      $res=mysql_query("SELECT stock_master.stock_id,stock_master.section,stock_master.make,stock_master.quantity,stock_master.deliver_from_godown, grade_master.grade_name,stock_master.grade_id FROM stock_master INNER JOIN grade_master ON stock_master.grade_id=grade_master.grade_id where stock_master.grade_id='".$des."'");
                 }
                 ...
                 { 
                         echo "<tr>"; ?>
                        <form action="submitinq.php" method="post" id="nameform">
                         ...
                         <td><input type="text"  name="delivery" value="<?php echo $r[4];?>" readonly></td>
